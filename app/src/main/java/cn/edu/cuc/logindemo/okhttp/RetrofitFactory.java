...
public class RetrofitFactory {
    ...
    public static final String CACHE_NAME = "cn.edu.cuc.logindemo";
    public static final String MUSIC_BASE_URL = URLConstant.MUSIC_BASE_URL;
    ...
    private RetrofitFactory() {
         ...
         * 设置缓存
         */
        File cacheFile = new File(AndroidApplication.getInstance().getExternalCacheDir(), CACHE_NAME);
