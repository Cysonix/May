...
import cn.edu.cuc.logindemo.Utils.RegexUtils;
import cn.edu.cuc.logindemo.Utils.StringUtils;
...
public class RegexCheck {
    ...
    public static boolean match(int type, String string) {
        return getMatch(type, string, null);
    }

    public static boolean match(int type, String string, String userRegxs) {
        return getMatch(type, string, userRegxs);
    }

    private static boolean getMatch(int type, String string, String userRegxs) {
        ...
        switch (type) {
            ...
            case EditTextType.TYPE_OF_USER_DEFINE:
                if (userRegxs != null && !StringUtils.isEmpty(userRegxs)) {
